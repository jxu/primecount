...
void check_phiyb(const PhiBlock& pb, const std::vector<uint64_t>& ref)
{
    for (uint64_t i = pb.zk1; i < pb.zk; ++i)
    {
...
void test_phi_block()
{
    ...
    const std::vector<uint64_t> phi11 =
    {
